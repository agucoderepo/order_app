...
SYSTEM_PROMPT = """
You are a data extraction assistant. Given a chat message (WhatsApp or Telegram) containing a
grocery or produce order, extract the client name (if mentioned) and a list of items with
quantities.
...
def parse_message(text: str, db: Session) -> dict:
    """
    Channel-agnostic message parsing, shared by whatsapp_parser and telegram_parser.
    1. Send raw chat text to Claude for structured extraction.
